...
const routes: Routes = [
  ...
  {
    path: 'view-vendor',
    loadChildren: () => import('./pages/super-admin/view-vendor/view-vendor.module').then( m => m.ViewVendorPageModule)
  },
  {
    path: 'edit-vendor',
    loadChildren: () => import('./pages/super-admin/edit-vendor/edit-vendor.module').then( m => m.EditVendorPageModule)
  },
  {
    path: 'driver',
  ...
  {
    path: 'edit-s',
    loadChildren: () => import('./pages/vendor-admin/edit-s/edit-s.module').then( m => m.EditSPageModule)
  },
  {
    path: 'view-s',
    loadChildren: () => import('./pages/vendor-admin/view-s/view-s.module').then( m => m.ViewSPageModule)
  }
